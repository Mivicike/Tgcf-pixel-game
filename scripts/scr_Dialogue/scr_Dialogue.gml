...
global.first_dialog = [
    { 
        ...
        expression: "Spr_Expression_XieLian_EyesClosed" // Xie Lian smiles with eyes closed
    },
    { 
        name: "Xie Lian", 
        ...
        expression: "Spr_Expression_XieLian_Default" // Default expression
    },
    { 
        name: "Store Owner", 
        msg: "Did it work?",
        // No expression specified - works fine without it!
    },
]
