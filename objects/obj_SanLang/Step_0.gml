...
if (mode != SANLANG_MODE.SCRIPTED && _in_range && !instance_exists(obj_HelpPopup) && DIALOGUE_MANAGER.can_dialogue_start() && !instance_exists(obj_SanLangDialogueOptions) && !instance_exists(Obj_Inventory) && !instance_exists(obj_GhostEncounterCutscene)) {
	can_talk = true;
...
if (DIALOGUE_MANAGER.is_dialogue_active() || movement_locked || instance_exists(obj_SanLangDialogueOptions)) {
